def call(Map pipelineParams) {
    pipeline {
        ...
        parameters {
            ...
            string(name: 'CPUS', defaultValue: '', description: 'optional, instance spec info, can retrive it automatically except preview instances')
            string(name: 'MEMORY', defaultValue: '', description: 'optional, instance spec info, can retrive it automatically except preview instances')
